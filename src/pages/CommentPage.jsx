...
function CommentPage(){
    ...
    return (
        <div className="container max-w-xl mx-auto relative overflow-hidden 
            ...
            <h1 className="text-center font-bold text-3xl">Write a comment about</h1>
            <h1 className="text-center font-bold text-3xl text-white mt-2">{game.name}</h1>
            ...
            <div className="flex justify-center">
                ...
                >
                   ...
                   <dialog open className="modal modal-bottom sm:modal-middle">
                    ...
                    >
                        <div className="flex justify-center">
                        <h3 className="font-bold text-lg text-green-500 text-center mr-2">
                        ...
                        <div className="modal-action mt-12 flex justify-center">
                            <form method="dialog">
                                <button className="btn btn-ghost pt-1">
                                    <Link to="/">
                                        Back Home
